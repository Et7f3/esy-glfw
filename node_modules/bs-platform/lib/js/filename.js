...
function check_suffix(name, suff) {
  if (name.length >= suff.length) {
    ...
    return Caml_bytes.bytes_to_string(Bytes.lowercase(Caml_bytes.bytes_of_string(s))) === Caml_bytes.bytes_to_string(Bytes.lowercase(Caml_bytes.bytes_of_string(suff)));
  } else {
    return false;
  }
}
